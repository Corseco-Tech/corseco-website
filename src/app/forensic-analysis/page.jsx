    ...
    return (
        <div className='lg:px-30  md:px-10 px-5 mt-20 lg:mb-20 mb-10 flex flex-col gap-10'>
            <div className='flex flex-col gap-10 justify-center '>
                ...
                <Image src={'/images/forensicanalysis.png'} alt='mettrade-ai' width={1000} height={1000} className='w-full h-full object-cover md:rounded-[24px] rounded-[8px]' /></div>
                 ...
                 <div className='flex flex-col gap-10'>
                  <div className='flex flex-col gap-2'>
                    ...
                    <ul className='list-disc list-inside text-[#808080] space-y-2'>
                        <li className='flex items-start md:items-center gap-2'> {bulletpoints()}  Altered images (Photoshop edits, clones, cut/paste)</li>
                        <li className='flex items-start md:items-center gap-2'> {bulletpoints()} Inconsistent metadata (fake GPS, timestamps, filenames)</li>
                         <li className='flex items-start md:items-center gap-2'> {bulletpoints()} Resubmitted or recycled photos from past shipments</li>
                        <li className='flex items-start md:items-center gap-2'> {bulletpoints()} Signs of physical tampering on packaging or products </li>
