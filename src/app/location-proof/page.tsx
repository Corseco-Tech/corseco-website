        ...
        <div className='lg:px-30  md:px-10 px-5 mt-20 lg:mb-20 mb-10 flex flex-col gap-10'>
            <div className='flex flex-col gap-10 justify-center '>
                ...
                <div className='flex justify-center w-full h-[460px]'>
                    <Image src={'/assets/location-proof.png'} alt='mettrade-ai' width={1000} height={1000} className='w-full h-full object-cover md:rounded-[24px] rounded-[8px]' />
                </div>
            ...
            <div className='flex flex-col gap-10'>
                <div className='flex flex-col gap-2'>
                    ...
                    <ul className='list-disc list-inside text-[#808080] space-y-2'>
                        <li className='flex items-start md:items-center gap-2'> {bulletpoints()} Geo-tagged photo/video capture validation</li>
                        <li className='flex items-start md:items-center gap-2'> {bulletpoints()} Timestamp and location verification</li>
                        <li className='flex items-start md:items-center gap-2'> {bulletpoints()} Mapping of inspection activity to factory, port, or warehouse</li>
                        <li className='flex items-start md:items-center gap-2'> {bulletpoints()} Alerts for mismatched location claims </li>
                    </ul>
                </div>  
                <div className='flex flex-col gap-2 '>
                    <p className='text-[24px] font-[700] text-[#1A1A1A] text-center sm:text-left leading-[120%]'>WHO IS IT FOR?</p>
                    <p className='flex  items-start md:items-center gap-2 text-[#808080] '> {bulletpoints()} Teams managing remote inspections, third-party inspectors, or suppliers in high-risk sourcing regions.</p>
                </div>
                <div></div>
                <div></div>
            </div>
