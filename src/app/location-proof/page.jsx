    ...
    return (
        <div className='lg:px-30  md:px-10 px-5 mt-20 lg:mb-20 mb-10 flex flex-col gap-10'>
            <div className='flex flex-col gap-10 justify-center '>
                ...
                <Image src={'/assets/location-proof.png'} alt='location-proof' width={1000} height={1000} className='w-full h-full object-cover md:rounded-[24px] rounded-[8px]' /></div>
                 ...
                 <div className='flex flex-col gap-10'>
                  <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex flex-col gap-2 '>
                        ...
                        <div className='flex  items-start md:items-center gap-2 text-[#808080] '> {bulletpoints()} Teams managing remote inspections, third-party inspectors, or suppliers in high-risk sourcing regions.</div>
