            ...
            <div className='flex flex-col gap-10 justify-center '>
                ...
                <div className= "flex flex-wrap items-center justify-center gap-10">
                   ...
                   <div className="flex flex-col gap-8 items-center">
                      ...
                      <p className="md:text-[24px] text-base  md:w-[70%] w-full text-center leading-[150%]">Book a demo today and find out how construction companies and suppliers are using Corseco to ensure material quality, reduce delays, and maintain safety standards.</p></div>
