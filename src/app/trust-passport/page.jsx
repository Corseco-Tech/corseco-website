    ...
    return (
        <div className='lg:px-30  md:px-10 px-5 mt-20 lg:mb-20 mb-10 flex flex-col gap-10'>
            <div className='flex flex-col gap-10 justify-center '>
                ...
                <Image src={'/images/trustpassport.png'} alt='mettrade-ai' width={1000} height={1000} className='w-full h-full object-cover md:rounded-[24px] rounded-[8px]' /></div>
                <div className='flex flex-col gap-2'>
                    ...
                    Trust Passport is your shipment’s digital proof of quality and compliance. Each report is generated by Corseco’s AI and contains authenticated inspection data, certificates, photos, and audit logs.</p>
                </div>
                 </div>
                 <div className='flex flex-col gap-10'>
                  <div className='flex flex-col gap-2'>
                    ...
                    <ul className='list-disc list-inside text-[#808080] space-y-2'>
                        <li className='flex items-start md:items-center gap-2'> {bulletpoints()}Summary of visual inspections, document checks, and location proof </li>
                        <li className='flex items-start md:items-center gap-2'> {bulletpoints()}AI-verified pass/fail statuses across configurable quality criteria</li>
                         <li className='flex items-start md:items-center gap-2'> {bulletpoints()} Export-ready PDF reports for customs, buyers, or internal QA</li>
                        <li className='flex items-start md:items-center gap-2'> {bulletpoints()}Timestamped and tamper-proof for traceability </li>
